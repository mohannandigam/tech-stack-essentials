...
services:
  ...
  timescaledb:
    ...
    volumes:
      - ./06-infrastructure/timescaledb/init.sql:/docker-entrypoint-initdb.d/init.sql
  ...
  grafana:
    ...
    ports:
      - "3000:3000"
    volumes:
      - ./06-infrastructure/grafana/dashboards:/etc/grafana/provisioning/dashboards
```
...
- [CQRS Pattern](../../02-architectures/microservices/README.md)
- [Time-Series Databases](../../06-infrastructure/docker/README.md)
- [IoT Best Practices](../../06-infrastructure/monitoring/README.md)
