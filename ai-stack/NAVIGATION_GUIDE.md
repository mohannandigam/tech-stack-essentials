...
- **[Architecture Patterns](../architectures/)**: Microservices, Event-Driven, Serverless
- **[Infrastructure Guides](../infrastructure/)**: Kubernetes, Docker, CI/CD
- **[Domain Examples](../domain-examples/)**: Industry-specific implementations
